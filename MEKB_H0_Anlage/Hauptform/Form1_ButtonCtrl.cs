    ...
    public partial class Form1 : Form
    {
        ...
        private void UpdateButton_Fahrstr_GL1_links()
        {
                ...
                Block2_nach_Gleis2.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_L1");
                if (ListID != -1)
                {
        ...
        private void UpdateButton_Fahrstr_GL2_links()
        {
                ...
                Block2_nach_Gleis2.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_L2");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL3_links()
        {
                ...
                Block2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_L3");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL4_links()
        {
                ...
                Block2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_L4");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL5_links()
        {
                ...
                Block2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_L5");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL6_links()
        {
                ...
                Block2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_L6");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_Block2_Einfahrt()
        {
                ...
                Gleis6_nach_Block1.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Einfahrt_L");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL1_rechts()
        {
                ...
                Rechts2_nach_Gleis6.GetGesetztStatus() )
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_R1"); 
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL2_rechts()
        {
                ...
                Rechts2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_R2");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL3_rechts()
        {
                ...
                Rechts2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_R3");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL4_rechts()
        {
                ...
                Rechts2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_R4");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL5_rechts()
        {
                ...
                Rechts2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_R5");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_GL6_rechts()
        {
                ...
                Rechts2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Ausfahrt_R6");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_Rechts1_nach_Hbf()
        {
                ...
                Rechts2_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_RTunnel_1"); 
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_Rechts2_nach_Hbf()
        {
                ...
                Rechts1_nach_Gleis6.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_RTunnel_2");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_Schatten11_Ausf()
        {
                ...
                Schatten8_nach_Block7.GetGesetztStatus() )
            {
                ...
                int ListID = GetSignalListenID("Signal_Schatten11");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_Schatten10_Ausf()
        {
                ...
                Schatten8_nach_Block7.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Schatten10");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_Schatten9_Ausf()
        {
                ...
                Schatten8_nach_Block7.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Schatten9");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
        ...
        private void UpdateButton_Fahrstr_Schatten8_Ausf()
        {
                ...
                Schatten9_nach_Block7.GetGesetztStatus())
            {
                ...
                int ListID = GetSignalListenID("Signal_Schatten8");
                if (ListID != -1)
                {
                    if (Signalliste[ListID].Zustand != 0) Signalliste[ListID].Schalten(0, z21Start);
                }
